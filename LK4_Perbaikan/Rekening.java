public class Rekening {
    ...
    public Rekening(int no_rek, String nama, int password, int pin) {
    ...
    public Rekening(int no_rek, String nama, long nominal, int password, int pin) {
        nomorRekening = no_rek;
        saldo = nominal;
        this.nama = nama;
        this.password = password;
    ...
    public void isiSaldo(long nominal) {
        ...
        if (nominal < minimal) {
            System.out.println("nilai minimal " + mataUang + minimal);
        } else {
            saldo += nominal;
    ...
    public void transfer(long nominal) {
        ...
        if (saldo < minimal) {
            System.out.println("Saldo akhir di bawah " + mataUang + minimal);
        } else {
            saldo -= nominal;
